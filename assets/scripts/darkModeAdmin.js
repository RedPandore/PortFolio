...
newElem.innerHTML = '<div class="dark-mode-toggle"><input class="checkbox" type="checkbox"><label class="switch"><i class="fas fa-sun"></i><i class="fas fa-moon"></i><div class="ball"></div></label></div>'
